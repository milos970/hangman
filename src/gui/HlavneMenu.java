...
public class HlavneMenu extends javax.swing.JFrame {
    ...
    private void animacia() throws InterruptedException {
        int i = 1;
        while (i <= 7) {
            this.jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/obrazky/animacia/" + i + ".png")));
            Thread.sleep(500);
            i++;
        }    
    }  
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        this.novaHra = new NovaHra(this.color, this.skore, this);
        this.novaHra.zobraz();   
