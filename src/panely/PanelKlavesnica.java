...
public class PanelKlavesnica extends javax.swing.JPanel implements IPanely {
    ...
    private void initComponents() {
        ...
        jButton18.addActionListener(evt -> jButton18ActionPerformed());
        add(jButton18);
        ...
        jButton20.addActionListener(evt -> jButton20ActionPerformed());
        add(jButton20);

        jButton21.setText("U");
        jButton21.setFocusPainted(false);
        jButton21.addActionListener(evt -> jButton21ActionPerformed());
        add(jButton21);

        jButton22.setText("V");
        jButton22.setFocusPainted(false);
        jButton22.addActionListener(evt -> jButton22ActionPerformed());
        add(jButton22);

        jButton23.setText("W");
        jButton23.setFocusPainted(false);
        jButton23.addActionListener(evt -> jButton23ActionPerformed());
        add(jButton23);

        jButton24.setText("X");
        jButton24.setFocusPainted(false);
        jButton24.addActionListener(evt -> jButton24ActionPerformed());
        add(jButton24);

        jButton25.setText("Y");
        jButton25.setFocusPainted(false);
        jButton25.addActionListener(evt -> jButton25ActionPerformed());
        add(jButton25);

        jButton26.setText("Z");
        jButton26.setFocusPainted(false);
        jButton26.addActionListener(evt -> jButton26ActionPerformed());
        add(jButton26);
    ...
    private void jButton15ActionPerformed() {//GEN-FIRST:event_jButton15ActionPerformed
        this.jButton15.setEnabled(false);
        this.hra.hadaj('O');
    }//GEN-LAST:event_jButton15ActionPerformed

    private void jButton16ActionPerformed() {//GEN-FIRST:event_jButton16ActionPerformed
        this.jButton16.setEnabled(false);
        this.hra.hadaj('P');
    }//GEN-LAST:event_jButton16ActionPerformed

    private void jButton17ActionPerformed() {//GEN-FIRST:event_jButton17ActionPerformed
        this.jButton17.setEnabled(false);
        this.hra.hadaj('Q');
    }//GEN-LAST:event_jButton17ActionPerformed

    private void jButton18ActionPerformed() {//GEN-FIRST:event_jButton18ActionPerformed
        this.jButton18.setEnabled(false);
        this.hra.hadaj('R');
    }//GEN-LAST:event_jButton18ActionPerformed

    private void jButton19ActionPerformed() {//GEN-FIRST:event_jButton19ActionPerformed
        this.jButton19.setEnabled(false);
        this.hra.hadaj('S');
    }//GEN-LAST:event_jButton19ActionPerformed

    private void jButton20ActionPerformed() {//GEN-FIRST:event_jButton20ActionPerformed
        this.jButton20.setEnabled(false);
        this.hra.hadaj('T');
    }//GEN-LAST:event_jButton20ActionPerformed

    private void jButton21ActionPerformed() {//GEN-FIRST:event_jButton21ActionPerformed
        this.jButton21.setEnabled(false);
        this.hra.hadaj('U');
    }//GEN-LAST:event_jButton21ActionPerformed

    private void jButton22ActionPerformed() {//GEN-FIRST:event_jButton22ActionPerformed
        this.jButton22.setEnabled(false);
        this.hra.hadaj('V');
    }//GEN-LAST:event_jButton22ActionPerformed

    private void jButton23ActionPerformed() {//GEN-FIRST:event_jButton23ActionPerformed
        this.jButton23.setEnabled(false);
        this.hra.hadaj('W');
    }//GEN-LAST:event_jButton23ActionPerformed

    private void jButton24ActionPerformed() {//GEN-FIRST:event_jButton24ActionPerformed
        this.jButton24.setEnabled(false);
        this.hra.hadaj('X');
    }//GEN-LAST:event_jButton24ActionPerformed

    private void jButton25ActionPerformed() {//GEN-FIRST:event_jButton25ActionPerformed
        this.jButton25.setEnabled(false);
        this.hra.hadaj('Y');
    }//GEN-LAST:event_jButton25ActionPerformed

    private void jButton26ActionPerformed() {//GEN-FIRST:event_jButton26ActionPerformed
