...
public class NovaHra extends javax.swing.JFrame implements FocusListener {
    ...
    private void vytvorHru() {
        ...
        if (this.jTextField1.getText().length() > 10 && !this.jTextField1.getText().trim().isEmpty()) {
            ...
            this.jLabel3.setVisible(this.jTextField1.getText().trim().isEmpty());
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setFont(new java.awt.Font("Tahoma", Font.PLAIN, 10)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Tahoma", Font.PLAIN, 10)); // NOI18N
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(() -> new NovaHra().setVisible(true));
    }
